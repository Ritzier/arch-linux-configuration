import adblock_config
import grease_manager
import keymap
import themes
...
config.set(
    ...
    True,
    "file:///home/ritzier/.local/share/qutebrowser/userscripts/*",
)
...
c.completion.web_history.max_items = 0  # Disable history
c.messages.timeout = 850  # Notify show time

c.colors.webpage.darkmode.enabled = True

themes.setup(c)
keymap.setup(config)
adblock_config.setup(c)
